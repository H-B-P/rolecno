...
def linear_model_with_interxns(trainDf, testDf, max_depth=2, printem=False):
 ...
 linearModel = sm.GLM(trainDf["y"], trainDf[explanatories], family=sm.families.Gaussian())
 linearModel = linearModel.fit()
...
if __name__ == '__main__':
 df=gen.generate()
 print("MD0")
 print(linear_model_with_interxns(df,df,0))
 print("MD1")
 print(linear_model_with_interxns(df,df,1))
 print("MD2")
