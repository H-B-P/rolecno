...
if __name__ == '__main__':
 df1=gen.generate(50, 10, 1, 1000, 1000)
 df2=gen.generate(50, 10, 1, 1000, 1000)
 print("TD1")
 ...
 print("TD8")
 print(model(df1,df2,{'max_depth':8,'learning_rate':0.3}, rounds=100))
 print("TD9")
 print(model(df1,df2,{'max_depth':9,'learning_rate':0.3}, rounds=100))
 print("TD10")
 print(model(df1,df2,{'max_depth':10,'learning_rate':0.3}, rounds=100))
