...
if __name__ == '__main__':
 df1=gen.generateIII(100, 2000, False)
 df2=gen.generateIII(100, 2000, False)
 print(canonically_model(df1,df2, 1000, 1, 0.002))
 print(canonically_model(df1,df2, 1000, 2, 0.002))
 print(canonically_model(df1,df2, 1000, 3, 0.002))

 print(canonically_model(df1,df2, 2000, 1, 0.002))
 print(canonically_model(df1,df2, 2000, 2, 0.002))
 print(canonically_model(df1,df2, 2000, 3, 0.002))
