...
if __name__ == '__main__':
 ...
 print("truecanon 1")
 print(canonical_mixes_subpopulations.canonically_model(df1,df2, 1000, 0.1, 0.1))
 print("truecanon 2")
 print(canonical_mixes_subpopulations.canonically_model(df1,df2, 10000, 0.1, 0.1))
 print("truecanon 3")
 print(canonical_mixes_subpopulations.canonically_model(df1,df2, 10000, 0.1, 0))
 print("truecanon 4")
 print(canonical_mixes_subpopulations.canonically_model(df1,df2, 10000, 0.1, 0.01))
